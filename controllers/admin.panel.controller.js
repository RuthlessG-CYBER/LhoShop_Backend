...
export const downloadInvoice = async (req, res) => {
  try {
    const { id } = req.params;
const payment = await Payments.findOne({ orderId: id.trim() })     
 .populate("userId", "name email phone")
    ...
    doc
      ...
      .fontSize(11)
      .font("Helvetica")
      .text(`#${payment.orderId || "N/A"}`, 400, 85, {
        width: 145,
        align: "right",
      });
    ...
    doc
      .strokeColor("#E5E5E5")
      .lineWidth(1)
      .roundedRect(50, currentY, 245, 90, 8)
      .stroke();
    ...
    doc
      ...
      .fontSize(9)
      .font("Helvetica-Bold")
      .text(payment.paymentId || "N/A", 440, currentY + 35, {
        width: 90,
        align: "right",
      });
    ...
    doc
      ...
      .fontSize(9)
      .font("Helvetica-Bold")
      .text(payment.status || "N/A", 440, currentY + 55, {
        width: 90,
        align: "right",
      });
    ...
    if (payment.address) {
      ...
      doc
        .strokeColor("#E5E5E5")
        .lineWidth(1)
        .roundedRect(50, currentY, 495, 70, 8)
        .stroke();
    ...
    payment.items.forEach((item, index) => {
      ...
      doc
        ...
        .fontSize(9)
        .font("Helvetica")
        .text((item.quantity || 1).toString(), 325, currentY + 4, {
          width: 70,
          align: "center",
        });
      ...
      doc
        ...
        .fontSize(9)
        .font("Helvetica-Bold")
        .text(`₹${itemTotal.toLocaleString("en-IN")}`, 485, currentY + 4, {
          width: 50,
          align: "right",
        });
    ...
    doc
      ...
      .fontSize(10)
      .font("Helvetica-Bold")
      .text(`₹${subtotal.toLocaleString("en-IN")}`, 485, currentY, {
        width: 50,
        align: "right",
      });
    ...
    doc
      ...
      .fontSize(10)
      .font("Helvetica-Bold")
      .text(`₹${Math.round(tax).toLocaleString("en-IN")}`, 485, currentY, {
        width: 50,
        align: "right",
      });
    ...
    if (payment.delivaryStatus) {
      ...
      doc
        .strokeColor("#E5E5E5")
        .lineWidth(1)
        .roundedRect(50, currentY, 495, 35, 6)
        .stroke();
      ...
      const deliveryColor =
        payment.delivaryStatus === "Delivered"
          ? successColor
          : payment.delivaryStatus === "Pending"
            ? "#F59E0B"
            : accentColor;
    ...
    doc
      ...
      .fontSize(8)
      .font("Helvetica")
      .text("Thank you for shopping with LhoShop!", 50, 780, {
        align: "center",
        width: 495,
      });
...
export const downloadSalesReportPDF = async (req, res) => {
  try {
    ...
    const deliveredOrders = payments.filter(
      (p) => p.delivaryStatus === "Delivered",
    ).length;
    const pendingOrders = payments.filter(
      (p) =>
        p.delivaryStatus === "Pending" || p.delivaryStatus === "Processing",
    ).length;
    ...
    doc
      .fillColor("#E5E5E5")
      .fontSize(10)
      .text(`Generated on ${reportDate}`, 400, 75, {
        width: 145,
        align: "right",
      });
    ...
    doc
      .strokeColor("#E5E5E5")
      .lineWidth(1)
      .roundedRect(50, currentY, cardWidth, cardHeight, 8)
      .stroke();
    ...
    doc
      .strokeColor("#E5E5E5")
      .lineWidth(1)
      .roundedRect(50 + cardWidth + cardGap, currentY, cardWidth, cardHeight, 8)
      .stroke();
    ...
    payments.forEach((payment, index) => {
      ...
      doc
        ...
        .fontSize(8)
        .font("Helvetica-Bold")
        .text(paymentStatusText, 305, currentY + 6, {
          width: 75,
          align: "center",
        });
      ...
      else if (deliveryStatus === "Pending" || deliveryStatus === "Processing")
        deliveryColor = warningColor;
    ...
    for (let i = range.start; i < range.start + range.count; i++) {
      ...
      doc
        ...
        .fontSize(8)
        .font("Helvetica")
        .text("LhoShop Sales Report - Confidential", 50, 780, {
          width: 250,
          align: "left",
        });

      doc.text(`Page ${i + 1} of ${range.count}`, 0, 780, {
        width: 545,
        align: "right",
      });
    }
  ...
  try {
    ...
    for (let i = range.start; i < range.start + range.count; i++) {
      ...
      doc
        ...
        .fontSize(8)
        .font("Helvetica")
        .text("LhoShop User Report - Confidential", 50, 780, {
          width: 250,
          align: "left",
        });
  ...
  try {
    ...
    products.forEach((product, index) => {
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .text(
          (product.name || "N/A").substring(0, 32) +
      ...
      doc
        ...
        .fontSize(9)
        .font("Helvetica-Bold")
        .text((product.stock || 0).toString(), 405, currentY + 4, {
          width: 60,
          align: "center",
        });
    ...
    for (let i = range.start; i < range.start + range.count; i++) {
      ...
      doc
        ...
        .fontSize(8)
        .font("Helvetica")
        .text("LhoShop Stock Report - Confidential", 50, 780, {
          width: 250,
          align: "left",
        });
...
export const downloadAdminRoleReportPDF = async (req, res) => {
  try {
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .text(
        (roleCount["superadmin"] || 0).toString(),
        60 + cardWidth + cardGap,
        currentY + 35,
      );
    ...
    admins.forEach((admin, index) => {
      ...
      const roleColor =
        admin.role === "superadmin" ? successColor : accentColor;
      const roleText =
      ...
      drawRoundedRect(
        ...
        18,
        4,
        roleColor === successColor ? "#D1FAE5" : "#F3F4F6",
      );
    ...
    for (let i = range.start; i < range.start + range.count; i++) {
      ...
      doc
        ...
        .fontSize(8)
        .font("Helvetica")
        .text("LhoShop Admin Report - Confidential", 50, 780, {
          width: 250,
          align: "left",
        });
...
export const exportDashboardPDF = async (req, res) => {
  try {
    ...
    recentOrders.forEach((order, index) => {
      ...
      doc
        .fillColor(statusColor)
        .text(order.delivaryStatus || "Unknown", 320, currentY + 3, {
          width: 100,
        });
    ...
    recentTickets.forEach((ticket, index) => {
      ...
      doc
        .fillColor(ticketStatusColor)
        .text(ticket.status || "Unknown", 400, currentY + 3, { width: 80 });

      doc
        .fillColor(accentColor)
        .text(ticket.priority || "Normal", 490, currentY + 3, {
          width: 55,
          align: "right",
        });
    ...
    for (let i = range.start; i < range.start + range.count; i++) {
      ...
      doc
        ...
        .fontSize(8)
        .font("Helvetica")
        .text("LhoShop Dashboard Report - Confidential", 50, 780, {
          width: 250,
          align: "left",
        });
